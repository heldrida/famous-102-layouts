#famous 102 layout
> Lesson, tp [ractoce ,alomg res[pmsove layouts using some assembled widgets as well as basic components.

[![Build Status](https://travis-ci.org/heldrida/famous-102-layout.svg?branch=master)](https://travis-ci.org/heldrida/famous-102-layout) [![Dependency Status](https://david-dm.org/heldrida/famous-102-layout.svg)](https://david-dm.org/heldrida/famous-102-layout) [![devDependency Status](https://david-dm.org/heldrida/famous-102-layout/dev-status.svg)](https://david-dm.org/heldrida/famous-102-layout#info=devDependencies)
...
## Release History
 * 2014-09-16   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)